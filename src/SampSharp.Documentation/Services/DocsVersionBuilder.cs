...
{
	public class DocsVersionBuilder : IDocsVersionBuilder
	{
		private readonly IDocumentationDataRepository _docVersionRepository;

		public DocsVersionBuilder(IDocumentationDataRepository docVersionRepository)
		{
